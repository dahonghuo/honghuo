...
#ifndef _HONGHUORPC_CLIENT_H_
#define _HONGHUORPC_CLIENT_H_ 1
...
/** Show help message for honghuo-cli.
 ...
 *
 * @note the argument can be removed once honghuo-cli functionality is removed from Dacrsd
 */
