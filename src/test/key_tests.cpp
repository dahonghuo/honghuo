...
//static const CHonghuoAddress addr1C("1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs");
//static const CHonghuoAddress addr2C("1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs");
...
//static const CHonghuoAddress addr1C("n4PwAoA9zQ3SrndjB4wp8QWb9xPpNdtLsW");
//static const CHonghuoAddress addr2C("mfu2Z1UfUBkWQACSXVDr25h5UVU7LmC3xB");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CHonghuoAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    CHonghuoSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
...
//    BOOST_CHECK(addr2C.Get() == CTxDestination(pubkey2C.GetID()));
	if (fRegTest || fTestNet) {
		CHonghuoAddress addr1Ct("dgZjR2S98gmdvXDzwKASxKiaGr9Dw1GD8F");
		CHonghuoAddress addr2Ct("dw3Ard8fFMvt7nRppEr9cDAoRCCvNxj6vE");

		BOOST_CHECK(addr1Ct.Get() == CTxDestination(pubkey1C.GetKeyID()));
		BOOST_CHECK(addr2Ct.Get() == CTxDestination(pubkey2C.GetKeyID()));
	} else {
		CHonghuoAddress addr1Cm("1NoJrossxPBKfCHuJXT4HadJrXRE9Fxiqs");
		CHonghuoAddress addr2Cm("1CRj2HyM1CXWzHAXLQtiGLyggNT9WQqsDs");
